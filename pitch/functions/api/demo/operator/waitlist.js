import { callOperatorWaitlistRpc, checkOrigin, json, operatorAllowed, readJson, requirePost } from '../_shared.js';
...
export const onRequestPost = async ({ request, env }) => {
  ...
  const result = await callOperatorWaitlistRpc(env, { ...body, operator: true });
  const conflictErrors = ['table_unavailable', 'table_size_mismatch', 'table_required', 'section_mismatch'];
